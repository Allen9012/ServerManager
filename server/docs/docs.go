    ...
    "paths": {
        "/FP/createFilePermission": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建描述文件权限的信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/file.FilePermission"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "email": {
                    "$ref": "#/definitions/github_com_Allen9012_ServerManager_server_config.Email"
                },
                "excel": {
        ...
        "github_com_Allen9012_ServerManager_server_config.Email": {
            "type": "object",
            "properties": {
                "from": {

...
import (
	...
	ast2 "github.com/Allen9012/ServerManager/server/utils/ast"

	"github.com/Allen9012/ServerManager/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/Allen9012/ServerManager/server/%s/%s",
			packageNameF: "%s",
